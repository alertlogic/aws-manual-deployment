...
resource "aws_launch_configuration" "ids_appliance_lc" {
  name            = "AlertLogic IDS Security Launch Configuration ${var.account_id}/${var.deployment_id}/${var.availability_zones}/${var.vpc_id}"
...
resource "aws_autoscaling_group" "ids_appliance_asg" {
  name                 = "AlertLogic IDS Security Autoscaling Group ${var.account_id}/${var.deployment_id}/${var.availability_zones}/${var.vpc_id}"
  count  = "${var.create_ids}"
...
resource "aws_security_group" "ids_appliance_sg" {
  name        = "AlertLogic IDS Security Group ${var.account_id}/${var.deployment_id}/${var.availability_zones}/${var.vpc_id}"
  count  = "${var.create_ids}"
