...
deployment_id = "xxxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxxx" // Your AlertLogic Deployment ID
...
ids_subnet_id = ["subnet-xxxxxxxx", "subnet-xxxxxxxx", "..."] // List of subnet ID(s) where the IDS appliances will be deployed in
